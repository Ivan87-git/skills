...
- **Hard dependency** (`to-issues`, `to-prd`, `triage`) — include an explicit one-liner asking for missing repo guidance or setup details. Without the mapping, output is wrong, not just fuzzy.
