...
- **[setup-mp-devflow-skills](./setup-mp-devflow-skills/SKILL.md)** — Scaffold the per-repo config (issue tracker, triage label vocabulary, domain doc layout) that the other engineering skills consume.
...
- **[update-feature-docs](./update-feature-docs/SKILL.md)** — Update durable feature documentation so behavior and implementation decisions are understandable without reverse-engineering code.
